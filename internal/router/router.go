...
func NewRouter(dishHandler *DishHandler, userHandler *UserHandler, reservationHandler *ReservationHandler , paymentHandler *handler.PaymentHandler) *http.ServeMux {
